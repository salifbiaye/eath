...
export function AuthSection() {
  ...
  const authentification = "/assets/Authentification.mp4"
  const authentificationdark = "/assets/Authentification-dark.mp4"
  const authentificationimage = "/assets/authentification.png"
  const authentificationdarkimage = "/assets/authentificationdark.png"
    ...
    <section className="w-full py-12">
      ...
      <div className="px-7 mb-8 flex flex-col items-center justify-center">
        <div className="relative rounded-xl lg:block">
          ...
          <img
            src={authentificationdarkimage || "/placeholder.svg"}
            alt={t('altDark')}
          ...
          <img
            src={authentificationimage || "/placeholder.svg"}
            alt={t('altLight')}
